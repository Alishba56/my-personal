...
// transition={{ type: "spring", damping: 20, stiffness: 300 }}
// >
// <button onClick={onClose} className="absolute top-4 right-4 text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-200" >
// <X size={24} />
// </button>
// <h2 className="text-2xl font-bold mb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">
// Contact Me
...
// Name
// </label>
// <input name="name" type="text" id="name" value={formData.name} onChange={handleChange} className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required />
// </div>
// <div>
// <label htmlFor="email" className="block mb-1 font-medium text-purple-800 dark:text-purple-200">
// Email
// </label>
// <input name="email" type="email" id="email" value={formData.email} onChange={handleChange} className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required />
// </div>
// <div>
// <label htmlFor="message" className="block mb-1 font-medium text-purple-800 dark:text-purple-200">
// Message
// </label>
// <textarea name="message" id="message" value={formData.message} onChange={handleChange} className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white h-32" required ></textarea>
// </div>
// <button type="submit" disabled={isLoading} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-2 px-4 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-colors duration-300" >
// {isLoading ? 'Sending...' : 'Send Message'}
// </button>
// </form>
// </motion.div>
